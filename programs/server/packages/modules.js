...
install("bredikhin:contact-form");
install("chrismbeckett:toastr");
install("url");
install("http");
install("manuelschoebel:ms-seo");
install("dferber:prerender");
install("martino:i18n-conf");
install("martino:iron-router-i18n");
...
module.exports = {
  ...
  "_where": "/Users/alviga/Work/web/MeteorProjects/Vitagrad/vitagrad-master",
  "author": {
